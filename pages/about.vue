      ...
      <section class="relative py-20 bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 overflow-hidden">
        ...
        <div class="relative max-w-6xl mx-auto px-6">
          <div v-if="ownerStore.loading" class="text-center animate-pulse">
            <div class="w-40 h-40 bg-gray-300 dark:bg-gray-700 rounded-full mx-auto mb-8"></div>
...
<div class="animate-slide-up-delayed">
  ...
  onMounted(async () => {
    ...
    if (ownerStore.owner) {
      // Safely update head data
      headData.value.title = `About ${ownerStore.owner.name} - ${ownerStore.owner.headline}`
      headData.value.meta[0].content = `Learn more about ${ownerStore.owner.name} - ${ownerStore.owner.bio.substring(0, 160)}...`
    }
  })
